...
public class GreedyPath {
    ...
    public GreedyPath(List<Task> tasks, DefaultUndirectedWeightedGraph<Integer, DefaultWeightedEdge> arcGraph, List<Robot> robots, Double a, Double b) {
        this.tasks = tasks;
    ...
    public ExperimentResult greedyRun() {
        System.out.println("greedyPathRun");
        ...
        //执行任务迁移
        List<MigrationRecord> migrationRecords = new GreedyPathTasksMigration(idToGroups, idToRobots,shortestPath,arcGraph).taskMigration();
